...
//       {/* Benefit 1 */}
//       <div className="text-center p-6 rounded-lg bg-(--color-card-bg) animate-fade-in-slide">
//         <div
...
//       {/* Benefit 2 */}
//       <div
//         className="text-center p-6 rounded-lg bg-(--color-card-bg) animate-fade-in-slide"
...
// {/* CTA Buttons Section */}
// <section className="px-6 py-20 bg-linear-to-b from-[#f9f9f9] to-white">
