...
export function FavoriteProductCard({
  ...
  return (
    ...
    >
      ...
      <div className="md:w-full rounded-xl group overflow-hidden hover:text-[var(--color-navbar-bg)] flex flex-col h-full">
        <div className="relative rounded-xl overflow-hidden">
          ...
          <button
            onClick={addToCart}
            className="absolute scale-120 bottom-5 right-5 p-2 rounded-full bg-white/70 backdrop-blur-sm hover:bg-[var(--color-select)] opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            ...
            <div className="flex flex-col">
              {hasDiscount ? (
                <div className="flex flex-col">
                  ...
                  <span className="text-xl text-[var(--color-button-pink)]">
